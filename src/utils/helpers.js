...
export const AI_DIFFICULTY = {
  easy:   { label: '简单', color: '#00B894', accuracy: 0.45, thinkTime: [2000, 4000] },
  medium: { label: '中等', color: '#FDCB6E', accuracy: 0.60, thinkTime: [1200, 2500] },
  hard:   { label: '困难', color: '#FF6B6B', accuracy: 0.78, thinkTime: [600, 1500] },
}
...
export const AI_OPPONENTS = [
  { id: 'zhi', name: '小智同学', avatar: '🤖', personality: 'steady', difficultyLevels: ['easy', 'medium', 'hard'] },
  { id: 'hua', name: '学霸小花', avatar: '🐱', personality: 'aggressive', difficultyLevels: ['medium', 'hard'] },
  { id: 'hou', name: '快乐小猴', avatar: '🐵', personality: 'tricky', difficultyLevels: ['easy', 'medium'] },
  { id: 'tu', name: '勇敢小兔', avatar: '🐰', personality: 'aggressive', difficultyLevels: ['easy', 'medium', 'hard'] },
  { id: 'xiong', name: '聪明小熊', avatar: '🐻', personality: 'steady', difficultyLevels: ['easy', 'medium', 'hard'] },
]

export const RANK_TIERS = [
  { id: 'bronze',   name: '青铜', icon: '🥉', minWins: 0,  color: '#CD7F32' },
  { id: 'silver',   name: '白银', icon: '🥈', minWins: 3,  color: '#C0C0C0' },
  { id: 'gold',     name: '黄金', icon: '🥇', minWins: 8,  color: '#FFD700' },
  { id: 'platinum', name: '铂金', icon: '💎', minWins: 15, color: '#00CEC9' },
  { id: 'diamond',  name: '钻石', icon: '👑', minWins: 25, color: '#6C5CE7' },
]
